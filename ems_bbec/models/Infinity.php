...
class Infinity extends SoapClient {
	...
	public function __construct() { 	
		...
		if (!array_key_exists('login', $options)) {
			...
			$options["login"]="BLACKBAUDHOST\MilderLisondra17112";
		}
		if (!array_key_exists('password', $options)) {
			//$options["password"]="Un1Ty17!"; 
			$options["password"]="kZF4R8GCOrckYt"; 
		}

		if( $_SERVER['SERVER_NAME'] == 'ems.localhost' || gethostname() == 'SF-MILISO-MBP19' ){
			$wsdl = 'https://bbisec15stg.blackbaudhosting.com/17112_c45ea4a9-6acc-417a-9b46-03139f3c9575/AppFxWebService.asmx?wsdl'; // STAGING
		}else{
			//$wsdl = 'https://bbisec19prod.blackbaudhosting.com/17112_ed77bf07-ecb8-4c6f-b258-5fa8f1749b33/AppFxWebService.asmx?wsdl'; // PRODUCTION
			$wsdl = 'https://bbisec15stg.blackbaudhosting.com/17112_c45ea4a9-6acc-417a-9b46-03139f3c9575/AppFxWebService.asmx?wsdl'; // STAGING
		}
		print $wsdl . PHP_EOL;
...
$filterValues[] = $this->getStringFilter('STATEID', $STATEID);
			...
			$params=array(
				'FormID' => '5ca01211-25e7-4eba-9ffa-96994bcbeccb',
...
/* 			print '<pre>';
			...
			print '</pre>'; */
			if(isset($result->ID)){
/*				print "BBEC RETURNED GUID: " . $result->ID . PHP_EOL;
